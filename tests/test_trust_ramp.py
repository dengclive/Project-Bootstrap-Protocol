...
_REQUIRED_SETS = {
    ...
    "prefix-run-language-guard.json": {
        "sha256": "fd60c5a485f3aed265386084a40765a2"
                  "a7eef38bced5891fdd879609748ded04",
        "bypasses": ["g1foo", "g1noplus", "g1asg16", "g1red16", "g1path16",
                     "name_upper", "name_nodigit", "name_onechar",
                     "red_gtonly", "red_onedigit", "seg_noeq",
                     "leftpath-run-bounded", "expinner-run-bounded",
                     "exptail-run-bounded", "g2-drop-raise", "g2-drop-isascii",
                     "g2-drop-isalnum", "g2-twoloop-reintroduced",
                     "g2-assert-form",
                     "sredbound", "sred_ltonly", "sred_onedigit", "sred_oneop",
                     "wrapbound", "wrap-noslash",
                     "g3-alt1-nobacktick", "g3-alt2-nobacktick",
                     "g3-alt2-nodollar", "g3-drop-alt2head",
                     "g3-alt1-nodollar", "g3-drop-alt1",
                     "g-kw-nobang", "g-interp-trail-noparen",
                     "g-namedgrp-nocoproc", "g-wordrun-bound",
                     "head_noupper_ere", "head_noupper_bs",
                     "seg_noupper_ere", "seg_noupper_bs",
                     "g-nonabs-outer-bound",
                     "iw-leftpath-slashalt", "iw-interp-alt-nonode",
                     "pr-wrap-prefixalt-nodoas",
                     "pr-nonabs-braceclass-noleftbrace",
                     "nonabs-bracespace", "trailbrace-class",
                     "trailbrace-rep", "iw-leftpath-opt",
                     "fdclass", "tokenrep", "trailopt", "sinkrep"],
        "controls": ["control-inert-docstring"],
        "digest_suites": ["test_greenfield_golden.py", "test_retrofit.py"],
        "suites": ["test_composition.py", "test_substrate_differential.py"],
    },
    "pipe-rule-url-pipe-cubic.json": {
        "sha256": "3ecc1a16fc46582f67c561dcc097b8f0"
                  "34d2af61874566e08ec4df8af4197780",
        "bypasses": ["e0-strict", "no-segment-split", "split-semicolon-only",
                     ...
                     "one-site-re-search", "finditer-window",
                     "segment-length-cap", "pipe-window", "tail-flag",
                     "finditer-start-window", "pipe-window-64k"],
        "controls": ["control-inert-comment"],
        "digest_suites": ["test_greenfield_golden.py"],
