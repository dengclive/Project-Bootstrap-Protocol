...
try:
    ...
    check("AC-9-5: state records protocol 2.7.1",
...
check("AC-9-5: installer PROTOCOL_VERSION is 2.7.1",
      installer.PROTOCOL_VERSION == "2.7.1")
check("AC-9-5: templates PROTOCOL_VERSION is 2.7.1",
      templates.PROTOCOL_VERSION == "2.7.1")
