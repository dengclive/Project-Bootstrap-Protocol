...
- **Drift thresholds** — §6.D of `Bootstrap-Protocol-v2-4-0.md` (and the
  drift-detector hook config). The numbers above reflect this project's actual
  configured values.
- **Max-iterations and the subagent token-multiplier note** — Phase 9.5 of
  `Bootstrap-Protocol-v2-4-0.md`; the max-iterations value is configurable in
  `.claude/loop-config.md`.
