...
golden digest. `Bootstrap-Protocol-v2-8-0.md:209-212` excludes
...
insufficient iterations: `docs/changelog.md:1045` (the 2.7.1 → 2.7.2 section)
...
`docs/changelog.md:1045`; it also appears at
...
its concurrency budget is not machine capacity: `Bootstrap-Protocol-v2-8-0.md:423`
